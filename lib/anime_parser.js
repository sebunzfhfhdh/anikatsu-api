...
const BASE_URL = 'https://gogoanime-qdew.onrender.com/api/v1';

// Define API endpoints based on the provided routes
const endpoints = {
  search: (query) => `${BASE_URL}/Search/${query}`,
  animeEpisode: (id) => `${BASE_URL}/AnimeEpisodeHandler/${id}`,
  recentReleases: (page = 1) => `${BASE_URL}/RecentReleaseEpisodes/${page}`,
  recentlyAddedSeries: `${BASE_URL}/RecentlyAddedSeries`,
  ongoingSeries: `${BASE_URL}/OngoingSeries`,
  alphabet: (letter, page = 1) => `${BASE_URL}/Alphabet/${letter}/${page}`,
  newSeasons: (page = 1) => `${BASE_URL}/NewSeasons/${page}`,
  movies: (page = 1) => `${BASE_URL}/Movies/${page}`,
  popular: (page = 1) => `${BASE_URL}/Popular/${page}`,
  genre: (genre, page = 1) => `${BASE_URL}/Genre/${genre}/${page}`,
  decodeVidstreamingURL: `${BASE_URL}/DecodeVidstreamingIframeURL`,
};
